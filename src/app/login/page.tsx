    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-white">
      ...
      <main className="max-w-6xl mx-auto px-5 sm:px-6 pb-16">
        <div className="flex flex-col lg:flex-row lg:items-center gap-10 sm:gap-12 lg:gap-16 pt-4 lg:pt-14">
          ...
          {/* 좌측 히어로 (모바일에서도 먼저 노출) */}
          <div className="order-1 flex-1 space-y-6 sm:space-y-8">
          ...
          {/* 우측 로그인 카드 (모바일에서는 히어로 아래로) */}
          <div className="order-2 lg:w-80 xl:w-96 flex-shrink-0">
            ...
            <div className="text-center mt-4 lg:hidden">
              <Link href="/help/install"
                ...
                <HelpCircle className="w-3 h-3" /> 앱 설치 가이드 (iPhone / Android)
              </Link>
            </div>
          </div>
...
function AccessRequestModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      <div
        className="bg-white w-full sm:max-w-md rounded-t-3xl sm:rounded-3xl shadow-xl overflow-hidden max-h-[90vh] flex flex-col"
